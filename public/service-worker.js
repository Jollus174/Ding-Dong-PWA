...
var filesToCache = [
  ...
  '/images/stages/stage_bf',
  '/images/stages/stage_dl',
  '/images/stages/stage_fd',
  '/images/stages/stage_ly',
  '/images/stages/stage_sv',
  '/images/stages/stage_tc'
...
self.addEventListener('fetch', function(e) {
  ...
  if (e.request.url.indexOf(dataUrl) > -1) {
    /*
     * When the request URL contains dataUrl, the app is asking for the characters
